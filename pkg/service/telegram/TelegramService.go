...
func (telegramService *TelegramService) GetMessages() []*model.UpdatedMessage {
	...
	var messagesStack []*model.UpdatedMessage
...
func (telegramService *TelegramService) SendMessages(messages []*model.UpdatedMessage, wg *sync.WaitGroup) {
	defer wg.Done()
...
func (telegramService *TelegramService) StoreMessages(messages []*model.UpdatedMessage, wg *sync.WaitGroup) {
	defer wg.Done()
